...
- [ ] 2.2 Mark hourly buckets after `last_sync_at` as `missing: true`
- [ ] 2.3 Return `sync` metadata (last_sync_at, min_interval_minutes)
...
## 4. Dashboard UI
- [ ] 4.1 Respect `missing` in day trend (dashed markers + tooltip "未同步")
- [ ] 4.2 Add UI indicator for sync freshness (optional, low-visibility)

## 5. Docs + Validation
- [ ] 5.1 Update `BACKEND_API.md` for new endpoint/response fields
- [ ] 5.2 Add acceptance script for heartbeat + hourly missing
