...
export function ActivityHeatmap({
  ...
  if (!weeks.length) {
    return <div className="text-[12px] text-[#94A3B8]">{copy("heatmap.empty")}</div>;
  }
    ...
    >
      <div className="relative group">
        ...
        >
          ...
          >
            <div style={gridColumns} className="text-[11px] font-medium text-[#94A3B8] mb-2">
              <span></span>
            ...
            <div style={gridColumns}>
              <div
                style={labelRows}
                className="text-[11px] font-medium text-[#94A3B8] sticky left-0 z-10 bg-white pr-2"
              >
                {dayLabels.map((label) => (
              ...
              <div style={gridRows}>
                {weeks.map((week, wIdx) =>
                  (Array.isArray(week) ? week : []).map((cell, dIdx) => {
                    ...
                    const color = level === 0 ? "rgba(37,99,235,0.06)" : `rgba(37,99,235,${opacity})`;
                    ...
                    return (
                      <span
                        ...
                        className="rounded-[2px] border border-[#E2E8F0]"
                        style={{
                          width: CELL_SIZE,
                          height: CELL_SIZE,
                          background: color,
      ...
      <div
        ref={trackRef}
        className="heatmap-scrollbar-track relative h-[6px] rounded-full bg-[#F1F5F9] border border-[#E2E8F0] overflow-visible mt-1 transition-opacity duration-150"
        style={{
      ...
      >
        ...
        <div
          ref={thumbRef}
          className={`absolute top-0 bottom-0 rounded-full bg-[#2563EB]/40 hover:bg-[#2563EB]/60 ${
      ...
      {!hideLegend ? (
        <div className="flex justify-between items-center text-[11px] border-t border-[#E2E8F0] pt-2 text-[#94A3B8] font-medium">
                ...
                <span
                  ...
                  style={{
                    ...
                    background:
                      level === 0
                        ? "rgba(37,99,235,0.06)"
                        : `rgba(37,99,235,${OPACITY_BY_LEVEL[level]})`,
                  }}
                ></span>
              ))}
            </div>
