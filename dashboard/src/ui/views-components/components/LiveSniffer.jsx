...
export const LiveSniffer = () => {
  ...
  return (
    <div className="text-[12px] text-[#64748B] space-y-2 h-full flex flex-col justify-end">
      {logs.map((log, idx) => (
        <div key={idx} className="border-l-2 border-[#E2E8F0] pl-2 truncate text-[#94A3B8]">
          {log}
        </div>
      ))}
    </div>
